...
class AllAttracScreen extends StatefulWidget {
  const AllAttracScreen({
    Key? key,
  }) : super(key: key);
  @override
  _AllAttracScreenState createState() => _AllAttracScreenState();
}

class _AllAttracScreenState extends State<AllAttracScreen> {

...
class FoodTabReadyUse extends StatefulWidget {
  const FoodTabReadyUse({Key? key}) : super(key: key);

  @override
  _FoodTabReadyUseState createState() => _FoodTabReadyUseState();
}

class _FoodTabReadyUseState extends State<FoodTabReadyUse> {
  @override
  ...
  listorder() async {
    ...
    var url = "https://mtwa.xyz/API/show-vouchers";

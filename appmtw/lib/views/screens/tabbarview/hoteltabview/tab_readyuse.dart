...
class TabReadyUse extends StatefulWidget {
  const TabReadyUse({Key? key}) : super(key: key);

  @override
  _TabReadyUseState createState() => _TabReadyUseState();
}

class _TabReadyUseState extends State<TabReadyUse> {
  List<VouchersH> vou = <VouchersH>[];
  var resultDataVH;
  listvouchersHotel() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    final String? userId = prefs.getString('username');
    var link = "https://mtwa.xyz/API/show-vouchers-hotel";

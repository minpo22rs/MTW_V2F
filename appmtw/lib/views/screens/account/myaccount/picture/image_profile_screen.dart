...
import 'package:mtw_project/views/screens/account/myaccount/picture/image_background_screen.dart';
import 'package:mtw_project/views/screens/account/myaccount/picture/take_photo.dart';

class MainPic extends StatefulWidget {
  MainPic({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _MainPicState createState() => _MainPicState();
}

class _MainPicState extends State<MainPic> {

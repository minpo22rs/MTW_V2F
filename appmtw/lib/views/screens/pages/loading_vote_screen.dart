...
class LoadingVoteScreen extends StatefulWidget {
  const LoadingVoteScreen({
    Key? key,
  }) : super(key: key);
  @override
  _LoadingVoteScreenState createState() => _LoadingVoteScreenState();
}

class _LoadingVoteScreenState extends State<LoadingVoteScreen> {
  @override
  void initState() {
    super.initState();
    indexmain();
